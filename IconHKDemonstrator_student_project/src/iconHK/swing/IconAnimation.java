...
public class IconAnimation {
	...
	public IconAnimation(IconHKButton button, int[] states,int persistency){
		this.button = button;
		this.states = states;
	...
	public IconAnimation(IconHKButton button, int[] states){
		this.button = button;
		this.states = states;
		this.animationStep = 0;
		this.persistency = 0;
