...
class RangeSliderUI extends BasicSliderUI {
    ...
    /**
     * Constructs a RangeSliderUI for the specified rangeslider component.
     * @param b RangeSlider
     */
    ...
    /**
     * Creates a listener to handle track events in the specified rangeslider.
     */
    @Override
    ...
    /**
     * Creates a listener to handle change events in the specified rangeslider.
     */
    @Override
    ...
    /**
     * Paints the rangeslider.  The selected thumb is always painted on top of the
     * other thumb.
     */
    @Override
    ...
    /** 
     * Sets the location of the upper thumb, and repaints the rangeslider.  This is
     * called when the upper thumb is dragged to repaint the rangeslider.  The
     ...
     * locations and repaints the rangeslider if the value change is not caused by
     * dragging a thumb.
     */
    ...
    /**
     * Listener to handle mouse movements in the rangeslider track.
     */
